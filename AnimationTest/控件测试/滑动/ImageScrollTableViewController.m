//
//  ImageScrollTableViewController.m
//  AnimationTest
//
...
#import "ImageScrollTableViewController.h"
#import "ImageScrollTableViewCell.h"
#import <Haneke.h>
@interface ImageScrollTableViewController ()
@property (nonatomic, strong) NSMutableArray * array;
@end

@implementation ImageScrollTableViewController
...
-(void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([cell isKindOfClass:[ImageScrollTableViewCell class]]) {
        ...
        [cello sizeToFit];
        [cello.show hnk_setImageFromURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://ww4.sinaimg.cn/mw1024/%@.jpg",[self.array objectAtIndex:indexPath.row]]]placeholder:nil success:^(UIImage *image) {
            
            
            [cello.show performSelector:@selector(setImage:)
                                  withObject:image
                                  afterDelay:0
